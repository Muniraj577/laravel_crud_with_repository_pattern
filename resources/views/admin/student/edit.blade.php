                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="name"
                                                            ...
                                                            placeholder="Enter full name" id="" value="{{ $student->name }}">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="roll">Roll &nbsp;<span
                                                                class="req">*</span></label>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <input type="text" name="roll" id="roll" value="{{ $student->roll }}"
