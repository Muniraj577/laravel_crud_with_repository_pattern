                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="roles">Assign Roles&nbsp;<span class="req">*</span></label>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <?php 
                                                            ...
                                                            @foreach ($roles as $role)
                                                                <div class="col-md-4 form-check">
                                                                    <input type="checkbox" value="{{ $role->id }}" id="{{ $role->slug }}"
                                                                        class="form-check-input role example" name="roles[]" {{ in_array($role->slug, $user_roles) ? 'checked' : '' }}>
...
@section('scripts')
    <script>
        ...
        if ($("#superadmin").is(':checked')) {
            $('input:checkbox').not($("#superadmin")).prop({disabled: true, checked: false});
        } else {
